...
//https://github.com/NaverCloudPlatform/android-ai-sample/blob/master/app/src/main/java/com/ncp/ai/demo/process/OcrProc.java
...
public class ReceiptAddActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("path(receiptaddactivity) : " + Url);

        firebaseurl=fromGalleryIntent.getStringExtra("firebaseurl");
        System.out.println("firebaseurl receiptaddactivity에서 "+firebaseurl);
...
//        receiptItemDetailTitle.setText(ocrList.get(0));
        ...
        receiptAddRecyclerView.setAdapter(adapter);
        //--------------------파싱받은 어레이리스트 editText에 넣기-----------------------


        //완료버튼 눌렀을 때 데이터베이스에 넣기
        ...
        completeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < adapter.getItemCount(); i++) {
                    ...
                    System.out.println("영수증에 뭐라도 있니? : " + tmp.getProductName());
    ...
    private String getNaverHtml (String Url){
        ...
        String requestBody = "";
        String apiURL = "https://181179a6adb841b8ab1e8b4be9118655.apigw.ntruss.com/custom/v1/8823/b830c56e6f9165a6c627a8ed452a067e558257d865fd3184aabd84e473792550/general";
        String secretKey = "VFdabHhhQkFQTXBEbUphWGtyQ1ZSWHpMVlp1a2lTRmg=";
        ...
        try {
            ...
            System.out.println("response : " + response.toString()); // JSON파일 콘솔창에 프린트하기
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            getJson = naverHtml;
            System.out.println("getJson1 : " + getJson);
            System.out.println("Handler - " + naverHtml);
        }
    };
    ...
    private ArrayList jsonParsing(String json) {
        ...
        try{
            ...
            for(int i=0; i<imagesArray.length(); i++) {
                ...
                System.out.println("imagesString :" + imagesString);
    ...
    public class NaverThread extends Thread{
        public void run() {
            ...
            //System.out.print("NAVER HTML - 넘기기 성공" + naverHtml);
    ...
    public void ThreeForm(){
        System.out.println("ThreeForm 호출됨");
        for(int i=startPosition + 1; i<endPosition;) {
            String productName = ocrList.get(i);
            String productQuantity = ocrList.get(i+1);
            String productCost = "";
...
//            String productCost = ocrList.get(i+2);
            ...
            System.out.println("메뉴 : " + productName);
            System.out.println("수량 : " + productQuantity);
            System.out.println("금액 : " + productCost);
        }
    }
}