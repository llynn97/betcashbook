...
public class GroupDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ArrayList<String> budgetList=intent.getStringArrayListExtra("budgetList");
        //ArrayList<String> nicknameList=intent.getStringArrayListExtra("nicknameList");

        //System.out.println("bugetlist intent로 받아온거:"+budgetList);
        //System.out.println("bugetlist intent로 받아온거:"+nicknameList);
        ...
        // peopleNum = items.get(position).getPeopleNum();
        //친구초대코드
        ...
        System.out.println("gsgdgd: "+idList);
        System.out.println("시작날짜: "+items.get(position).getStartDay());
