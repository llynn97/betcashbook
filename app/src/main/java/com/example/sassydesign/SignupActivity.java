    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleLoginButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                dialogTitle.setText("구글 계정을 연동합니다.");
        ...
        validateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://192.168.1.6:3000/process/validate";
...
//                {
//                    Toast.makeText(SignupActivity.this,"올바른 ID가 아닙니다. 영문자와 숫자를 포함해주세요.",Toast.LENGTH_SHORT).show();
//                    dialog.dismiss();
//                    return;
//                }
                ...
                String url = "http://192.168.1.6:3000/process/register";
