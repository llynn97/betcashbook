...
public class GroupAddActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    String url="http://192.168.0.20:3000/process/addbetcashbook";
    String url2 = "http://192.168.0.20:3000/process/groupvalidate";
    String groupName;
    String goal;
    String goalMoney1;
    String reward;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("목표 금액 : " + "-" + goalMoney1+ "-");
        ...
        createInviteCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("랜덤 함수1 : " + "-" + random1+ "-");
                System.out.println("랜덤 함수2 : " + "-" + random2+ "-");
                System.out.println("랜덤 함수3 : " + "-" + random3+ "-");
                System.out.println("랜덤 함수4 : " + "-" + random4+ "-");

                //완성된 랜덤 코드 : random
                String newrandom = "";
                newrandom = String.valueOf(random1+random2+random3+random4);
                System.out.println("랜덤 코드 : " + "-" + newrandom+ "-");
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success)
                            {
                                ...
                                System.out.println("실제로 받아온 random 값이 뭐야ㅑ!!!!!!!!!!!!!!!"+random);
...
//                        random3 = String.valueOf((char) ((int) (rnd.nextInt(26))+65));
//                        random4 = String.valueOf((char) ((int) (rnd.nextInt(26))+65));
//                        random = String.valueOf(random1+random2+random3+random4);
//                    }
            }
        });
        ...
        betCreateCompleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("목표 금액 : " + "-" + goalMoney2+ "-");
...
//                adapter = ArrayAdapter.createFromResource( GroupAddActivity.this, R.array.category, R.layout.spinner );
//                adapter.setDropDownViewResource( android.R.layout.simple_spinner_dropdown_item );
//                betCreateSharedSpinner.setAdapter(adapter);
//                category = betCreateSharedSpinner.getSelectedItem().toString();
