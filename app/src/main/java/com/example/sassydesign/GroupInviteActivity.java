...
public class GroupInviteActivity extends AppCompatActivity {
    ...
    String url2 = "http://192.168.0.20:3000/process/idarraycheck";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("제발제바라ㅏㅏㄹㄹ"+idlist);

        System.out.println(code.getClass().getName());
        System.out.println("CODE!!!!!!!!!!!!!!!!!!!!!"+code);
        //Toast.makeText(this, groupAdapter.getItemCount(), Toast.LENGTH_SHORT).show();
        //고유코드로 데베에서 데이터 가져오기
        String randomCode = "";
        String groupName = "";
        String goal = "";
        ...
        //String[] IDlist = new String[code.get(10).charAt()];
        //stockArr = stockList.toArray(stockArr);
        ///String[] IDlist = .split("");
        //System.out.println(IDlist);
        //ArrayList<String> list3 = new ArrayList<>(Arrays.asList(IDlist));
        //인원수 증가해서 새로 만들기
        ...
        StringRequest request1 = new StringRequest(Request.Method.POST, url2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    System.out.println("ㅈㅎㅈㄷㅎㄷㅈ핟ㅎ잗ㅎㄷㅎ: "+jsonResponse);
                    System.out.println("jsonResponde 길이: "+jsonResponse.length());
                    ...
                    System.out.println("idlist의 사이즈"+idlist.size());
                    ...
                    for(int i = 0; i < idlist.size(); i++){
                        ...
                        System.out.println("카테고리 토탈 : " + categorytotal);
        ...
        //추가하려는 사용자의 정보를 가져오기기



        //원래 있던 데이터를 invitedGroup의 정보들로 바꾸기, 다 똑같고 인원수만 하나 증가시키면 됨
        //ArrayList에 초대 받은 사람의 정보(GroupUser) 넣기


        //현재 사용자 아이디의 내기가계부 목록에 invitedGroup 정보들 추가하기
