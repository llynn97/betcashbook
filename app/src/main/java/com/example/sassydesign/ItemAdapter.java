...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    //title1부터 productQuantity까지 그냥 선언한거임 데베에서 받아와야함 원래
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case 1001: //수정
                        ...
                        System.out.println("itemAdapter - position: " + getAdapterPosition());
                        //ModifyIntent.putExtra("position", Integer.toString(getAdapterPosition()));
                    ...
                    case 1002://삭제
                        ...
                        dialogButton2.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                String url = "http://192.168.0.20:3000/process/deleteitemlist";
                                //년, 월, 일 처리 부분
